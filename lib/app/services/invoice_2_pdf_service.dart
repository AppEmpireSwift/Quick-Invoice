...
part 'invoice_pdf_templates_extra.dart';
part 'invoice_pdf_template_elegance.dart';

enum PdfTemplate { classic, modern, minimal, bold, elegance }

class Invoice2PdfService {
  ...
  static Future<Uint8List> generateInvoice(
    ...
    switch (template) {
      ...
      case PdfTemplate.minimal:
        return _ExtraTemplates.generateMinimal(invoice, _font!, _fontBold!);
      case PdfTemplate.bold:
        return _ExtraTemplates.generateBold(invoice, _font!, _fontBold!);
      case PdfTemplate.elegance:
        return _EleganceTemplate.generateElegance(invoice, _font!, _fontBold!);
    }
  }
