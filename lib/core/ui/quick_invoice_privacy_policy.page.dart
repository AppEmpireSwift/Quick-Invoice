...
class QuickInvoicePrivacyPolicyPage extends StatelessWidget {
  const QuickInvoicePrivacyPolicyPage({super.key});
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      child: SafeArea(
        ...
        child: Text('''
This privacy policy applies to the ${QICore.config.appName} app (hereby referred to as "Application") for mobile devices that was created by The Developer (hereby referred to as "Service Provider") as a Freemium service. This service is intended for use "AS IS".
